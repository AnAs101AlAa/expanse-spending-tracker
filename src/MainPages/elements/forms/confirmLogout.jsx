    ...
    return (
        <>
            <div className="select-none fixed w-full h-full inset-0 z-30 flex justify-center bg-black bg-opacity-50 text-white">
                <div className="w-[40%] border-2 borderOuter animate-shadowGlow p-4 bodyDark rounded-lg my-auto text-white max-w-[500px] h-fit">
                    <X className="mb-1 size-6 hover:cursor-pointer" onClick={() => setOpen(false)} />
                    <p className="font-bold mx-auto text-3xl mb-8 mt-2 animate-textGlow text-center">Confirm Log Out</p>
