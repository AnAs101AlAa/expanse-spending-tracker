        ...
        <>
            ...
            <div className="dropdown dropdown-bottom">
                ...
                <ul tabIndex={0} className="text-white dropdown-content menu bg-base-100 -mt-2 rounded-box z-[1] w-44 p-4 shadow animate-shadowGlow border-2 border-teal-400">
                    <li onClick={() => navigate(`/account/${username}`)} className="duration-150 font-semibold ease-in-out text-md border-b-teal-400 hover:cursor-pointer hover:animate-textGlow border-b pb-2"><div className="flex gap-3 justify-center"><Settings /><p>Settings</p></div></li>
